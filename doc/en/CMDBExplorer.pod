...
The installer will prevent you from installing B<CMDBExplorer> on other
versions of the framework and ITSMConfigurationManagement module. This can be
easily overcomed by repackaging it though (see chapter I<PACKAGING> here above).
